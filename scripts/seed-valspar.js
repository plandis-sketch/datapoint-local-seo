/**
 * Seed script: Valspar Championship 2026
 *
 * Run from your terminal:
 *   node scripts/seed-valspar.js
 *
 * Uses the Firebase client SDK with your .env credentials.
 */
...
const tournament = {
  ...
  dates: {
    start: Timestamp.fromDate(new Date('2026-03-19T07:35:00-04:00')),
  ...
  entryFee: 0, // Test run — free entry
  status: 'picks_open',
};
...
async function seed() {
  ...
  console.log('Status: picks_open — you and Phil can start making picks!');
  process.exit(0);
}
